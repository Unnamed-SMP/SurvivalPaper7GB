# Github
`https://canary.discord.com/api/webhooks/825069131707580466/eef-rEDYdYCjaNpA6f0eA8TmouWYyITaqcfjztoHldYrV_OjlbOiS6w_z2acyIDYqv5p`

# GoogleForms
`https://canary.discord.com/api/webhooks/824949204530888705/IAdpTKgPKNkrVZ8gsgf-hyQABuAwtB9QtFTgvVt1wyNcfH0B9nmuP_7CxcItyJ5OknI8`
## Script:
```c++
...
const webhooks = ["https://canary.discord.com/api/webhooks/824949204530888705/IAdpTKgPKNkrVZ8gsgf-hyQABuAwtB9QtFTgvVt1wyNcfH0B9nmuP_7CxcItyJ5OknI8"];
...
const title = "Form Response", avatarImage = "", shortDescription = "", colour = "", mention = "<@&817885915686895689>", type = "";
